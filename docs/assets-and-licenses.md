...
`docs/images/product-hero.jpg` 是使用 OpenAI ImageGen 为本项目生成的原创桌面创作工作台主视觉，经本地缩放与 JPEG 压缩。它不包含人物、文字、第三方角色或品牌，仅用于本项目说明与宣传。
...
- `docs/screenshots/dashboard-overview.jpg`、`projects-overview.jpg`、`script-storyboard.jpg`、`image-workbench.jpg`、`audio-subtitle.jpg`、`preview-timeline.jpg`、`provider-settings.jpg` 均由本项目无 Key Demo Mode 通过 Browser 实机采集，路径已脱敏且不包含真实凭证；
