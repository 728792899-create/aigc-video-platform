<template>
  <div class="preview-page preview-grid">
      ...
      />
      <ExportStatusPanel class="export-action-panel" :library-path="exportLibraryDisplayPath" :copy-path="exportDefaultCopyPath" :long-project="isLongProject" :exporting="exporting" :task-id="exportTaskId" :result="exportResult" :error="exportError" :status-class="exportStatusClass" :title="exportStatusTitle" :status-text="exportStatusText" :progress="exportProgress" @export="handleExport" @library="goLibrary" @play="playExportedVideo" @download="downloadExportedVideo" />
...
<style scoped src="../styles/preview.css"></style>
